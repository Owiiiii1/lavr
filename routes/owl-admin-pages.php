...
$registerPersonalWorkspace = static function (string $prefix, string $as, array $middleware, bool $ownerStorage): void {
    Route::middleware($middleware)->prefix($prefix)->name($as.'.')->group(function () use ($ownerStorage): void {
        ...
        Route::get('/proactive', [JarvisProactiveController::class, 'index'])->name('proactive.index');
        Route::get('/proactive/{proposal}', [JarvisProactiveController::class, 'show'])->name('proactive.show');
        Route::post('/proactive/{proposal}/approve', [JarvisProactiveController::class, 'approve'])->name('proactive.approve');
        Route::post('/proactive/{proposal}/dismiss', [JarvisProactiveController::class, 'dismiss'])->name('proactive.dismiss');
        Route::post('/proactive/{proposal}/snooze', [JarvisProactiveController::class, 'snooze'])->name('proactive.snooze');
        Route::patch('/proactive/{proposal}', [JarvisProactiveController::class, 'update'])->name('proactive.update');
