...
final class MeetingToolPrompt
{
    ...
    public static function lines(): array
    {
        return [
            ...
            'Answers must come from stored analysis JSON. commitments_detected are analysis suggestions until promoted to first-class Commitments. Use list_commitments for operational promises. Do not invent decisions or owners.',
