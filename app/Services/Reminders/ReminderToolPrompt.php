...
final class ReminderToolPrompt
{
    ...
    public static function lines(): array
    {
        return [
            ...
            'The same split applies to Calendar and GitHub: “напомни мне проверить календарь” is a reminder; “каждое утро проверь календарь и расскажи, что сегодня” is a scheduled report. “Проверяй каждый день GitHub и сообщай о новых commit” is a watcher (condition). Periodic calendar/mail digest is create_scheduled_report, never a watcher.',
            ...
            'Dayparts such as "tomorrow morning" without a clock time are not exact — ask. This ask-for-time rule applies only to reminders, not to “каждое утро проверяй почту” (that is a scheduled report; default 08:00 local is allowed).',
