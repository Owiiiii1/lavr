...
final class WatcherToolPrompt
{
    ...
    public static function lines(): array
    {
        return [
            ...
            'The same LAVR-checks-vs-user-acts split applies to Calendar and GitHub. “Каждое утро проверь календарь и расскажи, что сегодня” → calendar watcher. “Проверяй каждый день GitHub и сообщай о новых commit” → github watcher. “Напомни мне проверить календарь” → reminder.',
