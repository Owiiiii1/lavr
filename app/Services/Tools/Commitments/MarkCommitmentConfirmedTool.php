...
final class MarkCommitmentConfirmedTool implements JarvisTool
{
    public const NAME = 'mark_commitment_confirmed';
    ...
    public function definition(): ToolDefinition
    {
        return new ToolDefinition(
            name: self::NAME,
            description: 'Mark a first-class commitment as confirmed (done) after explicit Owner confirmation. Do not set confirmed from AI evidence alone.',
            parameters: [
                'type' => 'OBJECT',
                'properties' => [
    ...
    public function meta(): ToolMeta
    {
        return new ToolMeta(
            ...
            confirmationHint: 'The Owner must confirm that this commitment is done.',
        );
    }
    ...
    public function execute(ToolCall $call, ToolExecutionContext $context): ToolResult
    {
        ...
        try {
            ...
            $updated = $this->commitments->markConfirmed(
                $context->user,
                $commitment,
                isset($call->arguments['note']) ? (string) $call->arguments['note'] : null,
            );
